...
public class patientInfoController extends SceneController {
	@FXML
	...
	@FXML
	private TextArea visitSummaries;
	@FXML
	...
	@FXML
	protected void changeInfo(ActionEvent event) throws IOException
	{
		switchToPatientChangeInfo(event);
	}
	
	@FXML
	protected void askQuestion(ActionEvent event) throws IOException
	{
		switchToPatientQA(event);
	}
